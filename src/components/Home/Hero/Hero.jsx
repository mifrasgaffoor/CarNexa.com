      ...
      <div className=" h-screen container flex flex-col justify-center md:flex-row items-center">
        ...
        <div className=" w-full md:w-2/4 space-y-5 mt-10">
          ...
          <p className=" text-sm lg:text-base">
            ...
            cumque corrupti.A aperiam recusandae <br />
            ratione ducimus molestias ab neque accusamus <br />
            eveniet cumque corrupti.
          </p>

          <div className="flex gap-8">
            <button className=" bg-green-600 py-1 px-4 rounded-md hover:scale-95 transition duration-150 ease-linear">
              Explore More
            </button>
            <button className="border-2 border-green-600 py-1 px-4 rounded-md hover:bg-green-600 transition duration-200 ease-linear">
              See Cars
            </button>
          </div>
        </div>
