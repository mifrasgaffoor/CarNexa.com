    ...
    <header className=" fixed w-full z-10 bg-secondary text-white py-4">
      ...
      <nav className=" container flex justify-between items-center">
        <div className=" flex items-center gap-2">
          <GiSteeringWheel size={35} className=" text-green-600" />
        ...
        <div className=" hidden md:flex items-center gap-8 font-medium text-xl">
          <Link
            to="/"
            className=" hover:text-green-600 transition duration-200 ease-linear"
          >
            Home
          </Link>
          <Link
          ...
          <button className=" hidden lg:flex border-2 border-green-600 text-lg px-4 rounded-md hover:bg-green-600 transition duration-200 ease-linear">
            Sign In
          </button>
        </div>
      ...
      >
        ...
        <div>
          <button className="border-2 border-green-600 py-1 px-4 rounded-md">
            Sign In
          </button>
        </div>
      </div>
